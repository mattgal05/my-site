...
export default async function ReasoningPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-14">
      ...
      {"This service evaluates arguments, updates probabilities with new evidence, and measure expected outcomes under certainty."}
      ...
      <section className="mt-12">
        ...
        {syllogism ? (
          <div className="mt-3 max-w-prose">
            ...
            {"I looked at the logical structure of the argument rather than whether the conclusion seemed believable."}
      ...
      <section className="mt-12">
        ...
        {plausibility ? (
          <div className="mt-3">
            ...
            {"The posterior represents the updated probability that the case is truly positive after considering both the base rate and the test results."}
          </div>
        ) : (
      ...
      <section className="mt-12">
        ...
        {bernoulli ? (
          <div className="mt-3">
            ...
            {"Expected payoff represents the average outcome over many similar decisions, not a guarantee of what will happen on one individual attempt."}
          </div>
        ) : (
